...
x = subprocess.run("~/anderson/code/mob_edge_fix_dis.exe {} {} {} {} {} {} {}".format(num_iterations, support, population_num,degree, epsilon, disorder, average_type),shell=True,stdout=PIPE).stdout.decode("utf-8").split(",")[:-1]
